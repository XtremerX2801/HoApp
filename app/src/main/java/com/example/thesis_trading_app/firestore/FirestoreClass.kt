package com.example.thesis_trading_app.firestore
...
import com.example.thesis_trading_app.models.Cart
import com.example.thesis_trading_app.models.User
import com.example.thesis_trading_app.ui.Admin.AddProductActivity
import com.example.thesis_trading_app.ui.Admin.ModifyProductActivity
import com.example.thesis_trading_app.ui.Authentication.LoginActivity
import com.example.thesis_trading_app.ui.Authentication.RegisterActivity
...
class FirestoreClass {
    ...
    fun registerUser(activity: RegisterActivity, userInfo: User, cartInfo: Cart) {
        ...
        cartHashMap[Constants.USER_ID] = cartInfo.user_id
        cartHashMap[Constants.CART_PRODUCT_NUM] = 0
        cartHashMap[Constants.CART_PRICE] = 0
        cartHashMap[Constants.CART_PRODUCTS] = cartInfo.cart_products
