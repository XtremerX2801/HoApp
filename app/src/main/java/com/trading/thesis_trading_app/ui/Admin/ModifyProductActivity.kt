...
//                        iv_user_photo.setImageURI(selectedImageFileUri)
    ...
    private fun updateProduct(barcode: Long) {
        val newProName = findViewById<com.trading.thesis_trading_app.utils.MTAEditText>(R.id.et_new_product_name)
        val newProCat = findViewById<com.trading.thesis_trading_app.utils.MTAEditText>(R.id.et_new_product_category)
        val newProPrice = findViewById<com.trading.thesis_trading_app.utils.MTAEditText>(R.id.et_new_product_price)
        val newProAmount = findViewById<com.trading.thesis_trading_app.utils.MTAEditText>(R.id.et_new_product_amount)
        val newProBarcode = findViewById<com.trading.thesis_trading_app.utils.MTAEditText>(R.id.et_new_product_barcode)
        val newProBrand = findViewById<com.trading.thesis_trading_app.utils.MTAEditText>(R.id.et_new_product_brand)
        val newProMadeIn = findViewById<com.trading.thesis_trading_app.utils.MTAEditText>(R.id.et_new_product_made_in)
        ...
        if (newProBarcode.text?.isNotEmpty() == true) {
            productHashMap[Constants.PRODUCT_NAME] = newProBarcode.text.toString()
        }
        if (newProBrand.text?.isNotEmpty() == true) {
            productHashMap[Constants.PRODUCT_NAME] = newProBrand.text.toString()
        }
        if (newProMadeIn.text?.isNotEmpty() == true) {
            productHashMap[Constants.PRODUCT_NAME] = newProMadeIn.text.toString()
        }
